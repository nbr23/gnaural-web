 ...
 * Lives outside the chart component so every surface that names a voice keys it with the same
 * colour.
 */
...
/** A colour per EEG band, for the surfaces that name one. Fixed slots rather than a gradient:
 *  these are five categories, not five points on a scale. */
